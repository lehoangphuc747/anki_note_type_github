...
### Card 2 - Review & Memorize Meaning
...
### Card 1 & Card 4 - Typing with Bold Colors
- **typeGood**: Dark green (#00796B) with background and border
- **typeBad**: Dark red (#C62828) with background, border and **underline**
- **typeMissed**: Dark blue (#1E88E5) with background and border
- Night Mode support

### Card 3 - Immersive View
- Focused, full-screen interface
- Displays only example sentences and translations
- Background: #F8F9FA

### Card 4 - Review Container
- White frame with border and shadow
- Displays typing results and original example sentences

## 📝 How to Use

1. Open Anki → **Tools** → **Manage Note Types**
2. Select your note type or create a new one
3. Copy content from corresponding template files into **Front Template** and **Back Template**
4. Copy all content from **STYLING.CSS** into the **Styling** section
5. Save and use!
...
**Note**: Files `*_RENDER_IN_HTML.html` are preview files to view the interface, not needed to copy into Anki.
